    ...
    Node.prototype.setData = function(o) {
      ...
      if (typeof o !== 'object') {
        ...
        for (key in o) {
          value = o[key];
          if (key === 'label') {
            var collectionLink = '<a id="collection_' + o['id'] + '">' + value + '</a>';
            var courseCount = ' (<span>' + o['count'] + '</span>)</a>';
            var deleteLink = '<a class="delete-collections" data-collection_id="' +
                              o['id'] +
                              '" rel="tooltip" title="Delete collection"><span class="icon icon-trash" /></a>';
            _results.push(this.name = collectionLink + courseCount + deleteLink);
          } else {
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
        ...
        li_classes = ['jqtree_common', 'jqtree-leaf'];
